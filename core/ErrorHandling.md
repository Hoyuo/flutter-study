...
> **💡 Either 타입 기초**
> 이 문서는 `Either<Failure, T>` 패턴을 사용합니다. Either의 기본 개념, fold/map/flatMap 사용법, TaskEither, Either.Do 문법 등 함수형 프로그래밍 기초는 [Fpdart.md](./Fpdart.md)를 먼저 학습하세요.
...
| 문서 | 설명 |
|------|------|
| [Fpdart.md](./Fpdart.md) | Either/Option/TaskEither 함수형 프로그래밍 기초 (fold, map, flatMap 사용법) |
| [Architecture.md](./Architecture.md) | Clean Architecture에서 에러 처리 레이어별 역할 |
| [Bloc.md](./Bloc.md) | Bloc State에 Failure 포함하고 UI에서 처리하는 패턴 |
| [Networking_Dio.md](../networking/Networking_Dio.md) | Dio 설정 및 인터셉터 구현 |
