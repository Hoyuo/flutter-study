...
mixin _$AppSettings {
 ...
 ThemeMode get themeMode; String get language; bool get notificationsEnabled;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode themeMode,  String language,  bool notificationsEnabled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppSettings() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode themeMode,  String language,  bool notificationsEnabled)  $default,) {final _that = this;
switch (_that) {
case _AppSettings():
return $default(_that.themeMode,_that.language,_that.notificationsEnabled);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode themeMode,  String language,  bool notificationsEnabled)?  $default,) {final _that = this;
switch (_that) {
case _AppSettings() when $default != null:
return $default(_that.themeMode,_that.language,_that.notificationsEnabled);case _:
  return null;
...
class _AppSettings extends AppSettings {
  const _AppSettings({this.themeMode = ThemeMode.system, this.language = 'en', this.notificationsEnabled = true}): super._();
