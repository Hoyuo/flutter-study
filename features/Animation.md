...
> **선행 학습**: [WidgetFundamentals](../fundamentals/WidgetFundamentals.md)
> **예상 학습 시간**: 2h
...
# pubspec.yaml
dependencies:
  lottie: ^3.3.2  # Lottie 애니메이션 (2026년 2월 기준)
  rive: ^0.14.2  # Rive 애니메이션 (선택사항)
  flutter_animate: ^4.5.2  # 선언적 애니메이션 헬퍼
  animations: ^2.1.1  # Material 모션 라이브러리
```
