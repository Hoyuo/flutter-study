...
```mermaid
flowchart TD
    T["위협 계층"] --> N["1. 네트워크 계층<br/>- MITM (중간자 공격)<br/>- SSL Stripping<br/>- Certificate Spoofing"]
    T --> A["2. 앱 계층<br/>- 코드 역공학 (Reverse Engineering)<br/>- 재패키징 (Repackaging)<br/>- 동적 분석 (Dynamic Analysis)"]
    T --> D["3. 데이터 계층<br/>- 로컬 저장소 접근<br/>- 메모리 덤프<br/>- 백업 파일 노출"]
    T --> P["4. 플랫폼 계층<br/>- Root/Jailbreak<br/>- 디버거 연결<br/>- 스크린샷/화면 녹화"]
```
